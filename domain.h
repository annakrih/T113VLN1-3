...
public:
    ...
    vector<Person> searchPersonName(vector<Person> people, QString search);           //name
    vector<Person> searchPersonNationality(vector<Person> people, QString search);    //nationality
    vector<Person> searchPersonGender(vector<Person> people, int search);           //gender
    ...
    vector<Computer> searchComputerName(vector<Computer> comp, QString search); //name
    vector<Computer> searchCDName(vector<Computer> comp, QString search); //computerdesign
    ...
    vector<Person> sortPersonByName(QString sortOrder,   vector<Person> pList);      // name
    vector<Person> sortPersonByGender(QString sortOrder, vector<Person> pList);      // gender
    vector<Person> sortPersonByBY(QString sortOrder, vector<Person> pList);          // birth year
    vector<Person> sortPersonByDY(QString sortOrder, vector<Person> pList);          // death year
    vector<Person> sortPersonByNat(QString sortOrder,    vector<Person> pList);      // nationality
    vector<Person> sortPersonByAge(QString sortOrder,    vector<Person> pList);      // age
